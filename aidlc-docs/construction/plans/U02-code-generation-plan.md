...
- [x] 13.5 款式新建/编辑支持选择、预览、替换、移除主图，并展示压缩结果
- [x] 13.6 款式管理、投产报表、站外推广增加可访问的固定尺寸主图缩略图
- [x] 13.7 本地诊断、前端生产构建、Python 编译及 migration null-byte/AST 校验通过
- [x] 13.8 提交并推送 main，等待 Zeabur frontend/backend 部署 RUNNING
- [x] 13.9 线上真实表单登录，验证压缩上传、三页展示、网络/控制台及后端日志
- [x] 13.10 移除测试主图并确认数据库、R2、本地测试文件均已清理
